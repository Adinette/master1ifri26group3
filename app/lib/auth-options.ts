...
export const authOptions: NextAuthOptions = {
  secret: process.env.NEXTAUTH_SECRET ?? process.env.JWT_SECRET ?? 'dev-secret-change-in-prod',
  session: {
  ...
  providers: [
    ...
    // Credentials Provider: désactivé si USER_SERVICE_URL indisponible
    ...(process.env.ENABLE_CREDENTIALS_PROVIDER !== 'false' ? [
      CredentialsProvider({
        name: "Credentials",
        credentials: {
