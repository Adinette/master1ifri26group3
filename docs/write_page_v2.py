"""
Nouveau template page.tsx — SFMC Bénin
Concept: "Terrain" — editorial, B2B, ancré dans le Bénin réel
Layout entièrement différent du premier: plus de numbered cards,
plus de carousel, plus de process à 4 étapes. Place au bento grid,
aux sections larges typographiques, et au contenu authentiquement béninois.
"""
...
function TemoignageCard({
  ...
  return (
    ...
    >
      <p style={{ color: '#1C1917', fontSize: '0.95rem', lineHeight: 1.7, marginBottom: '1.25rem', fontStyle: 'italic' }}>
        &laquo;&thinsp;{texte}&thinsp;&raquo;
      </p>
      <div style={{ borderTop: '1px solid #F5F0E8', paddingTop: '1rem' }}>
        <p style={{ fontWeight: 800, color: '#1C1917', fontSize: '0.9rem' }}>{nom}</p>
        <p style={{ color: '#D97706', fontSize: '0.78rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em' }}>{titre} — {ville}</p>
      </div>
    </div>
  )
}
  ...
  return (
    <Link
      ...
      style={{
        ...
        backgroundColor: dark ? '#1C1917' : 'white',
    ...
    >
      ...
      <div>
        <p style={{ fontWeight: 900, fontSize: '1.15rem', color: dark ? 'white' : '#1C1917', marginBottom: '0.25rem' }}>{label}</p>
        <p style={{ fontSize: '0.8rem', color: dark ? '#A8A29E' : '#78716C', fontWeight: 600 }}>{count} références</p>
        <p style={{ fontSize: '0.78rem', fontWeight: 700, color: '#D97706', marginTop: '0.5rem', letterSpacing: '0.04em' }}>
          VOIR &rarr;
        </p>
      </div>
    </Link>
...
export default function HomePage() {
  ...
  return (
    <main style={{ backgroundColor: '#FFFBF5', overflowX: 'hidden' }}>
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: '#D97706' }}>●</span> Cotonou — Abomey-Calavi — Parakou
          </div>
          ...
          >
            VOS CHANTIERS,<br />
            <span style={{ color: '#D97706', fontStyle: 'italic' }}>NOTRE FIERTÉ.</span>
          </h1>

          <p style={{ color: '#57534E', fontSize: '1.05rem', lineHeight: 1.7, maxWidth: '480px' }}>
          ...
          >
            {[
              ...
              <div key={i}>
                <p style={{ fontWeight: 900, fontSize: '1.6rem', color: '#D97706', lineHeight: 1 }}>{m.val}</p>
                <p style={{ fontSize: '0.73rem', color: '#78716C', fontWeight: 600, marginTop: '0.2rem' }}>{m.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        >
          ...
          >
            <defs>
              <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
                <path d="M 40 0 L 0 0 0 40" fill="none" stroke="#D97706" strokeWidth="0.8"/>
              </pattern>
            </defs>
          ...
          <div style={{ position: 'relative', textAlign: 'center', padding: '2rem' }}>
            ...
            <p style={{ color: '#A8A29E', fontSize: '0.85rem', marginTop: '0.5rem' }}>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Fondée à Cotonou.<br />
              <span style={{ color: '#D97706' }}>Présente partout.</span>
            </h2>
            <p style={{ color: '#57534E', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '1.25rem' }}>
            ...
            <p style={{ color: '#57534E', fontSize: '0.95rem', lineHeight: 1.8 }}>
            ...
            >
              <p style={{ fontStyle: 'italic', color: '#1C1917', fontSize: '1rem', fontWeight: 600, lineHeight: 1.6 }}>
                &laquo; Le Bénin construit vite. Il faut des partenaires qui suivent le rythme. &raquo;
              </p>
              <p style={{ color: '#D97706', fontWeight: 700, fontSize: '0.8rem', marginTop: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
          ...
          >
            {[
              ...
              <div
                key={i}
                style={{
                  backgroundColor: i % 2 === 0 ? '#FFFBF5' : 'white',
                  border: '1px solid #E7E5E4',
                  borderRadius: '0.875rem',
                  padding: '1.5rem',
                }}
              >
                <p style={{ fontWeight: 900, fontSize: '2rem', color: '#D97706', lineHeight: 1 }}>{item.val}</p>
                <p style={{ fontWeight: 700, color: '#1C1917', fontSize: '0.9rem', marginTop: '0.4rem' }}>{item.label}</p>
                <p style={{ color: '#78716C', fontSize: '0.75rem', marginTop: '0.2rem' }}>{item.sub}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section
        ref={secBento}
        style={{ padding: '5rem 0', backgroundColor: '#FFFBF5' }}
        id="catalogue"
      >
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ color: '#78716C', fontSize: '0.95rem', marginTop: '0.5rem' }}>
          ...
          <div style={{ marginTop: '1.75rem', textAlign: 'right' }}>
            ...
            >
              Tout le catalogue → {' '}
              <span style={{ fontSize: '0.7rem', backgroundColor: '#FEF3C7', padding: '0.2rem 0.5rem', borderRadius: '999px', color: '#92400E' }}>
                55 ref.
              </span>
            </Link>
          </div>
      ...
      <section
        ref={secFeatured}
        style={{ backgroundColor: '#1C1917', padding: '5rem 0' }}
      >
        <div
          style={{
            maxWidth: '1200px',
        ...
        >
          <div>
            ...
            >
              Ciment Portland<br />
              <span style={{ color: '#F59E0B' }}>CEM I 42.5N</span>
            </h2>
            <p style={{ color: '#A8A29E', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem', marginBottom: '2rem' }}>
              ...
              <span style={{ color: '#A8A29E', fontSize: '0.9rem' }}>FCFA / sac de 50 kg</span>
            </div>
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <Link
          ...
          >
            ...
            <div style={{ textAlign: 'center' }}>
              <p style={{ color: '#F59E0B', fontWeight: 900, fontSize: '1.1rem', letterSpacing: '0.04em', textTransform: 'uppercase' }}>
                CEM I 42.5N
              </p>
              <p style={{ color: '#57534E', fontSize: '0.8rem', marginTop: '0.25rem' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          >
            <div>
              ...
              >
                Nous livrons<br />
                <span style={{ color: '#D97706' }}>tout le Bénin.</span>
              </h2>
              <p style={{ color: '#57534E', fontSize: '0.9rem', lineHeight: 1.8 }}>
            ...
            >
              {[
                { ville: 'Cotonou', delai: '< 24h', badge: 'Express', couleur: '#D97706' },
                { ville: 'Abomey-Calavi', delai: '< 24h', badge: 'Express', couleur: '#D97706' },
                { ville: 'Porto-Novo', delai: '24–36h', badge: 'Rapide', couleur: '#2563EB' },
                { ville: 'Bohicon', delai: '36–48h', badge: 'Standard', couleur: '#57534E' },
                { ville: 'Abomey', delai: '36–48h', badge: 'Standard', couleur: '#57534E' },
                { ville: 'Parakou', delai: '48–72h', badge: 'Planifié', couleur: '#78716C' },
                { ville: 'Natitingou', delai: '72h+', badge: 'Sur devis', couleur: '#A8A29E' },
                { ville: 'Kandi', delai: '72h+', badge: 'Sur devis', couleur: '#A8A29E' },
                { ville: 'Lokossa', delai: '36–48h', badge: 'Standard', couleur: '#57534E' },
              ].map((item, i) => (
                <div
                  key={i}
                  style={{
                ...
                >
                  <p style={{ fontWeight: 800, color: '#1C1917', fontSize: '0.88rem' }}>
                    📍 {item.ville}
                  </p>
                  <p style={{ color: '#78716C', fontSize: '0.75rem', marginTop: '0.2rem' }}>{item.delai}</p>
                  <span
                    style={{
                      display: 'inline-block',
                      fontSize: '0.68rem',
      ...
      ══════════════════════════════════════════ */}
      <section style={{ backgroundColor: '#FEF3C7', padding: '4rem 0' }} id="services">
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          <div
            style={{
              display: 'grid',
            ...
            {[
              ...
              <div
                ...
                style={{
                  backgroundColor: 'white',
                  padding: '2rem 1.5rem',
                  borderRight: i < 3 ? '1px solid rgba(217,119,6,0.15)' : 'none',
                  borderBottom: 'none',
                }}
              >
                <p
                ...
                <h3 style={{ fontWeight: 800, color: '#1C1917', fontSize: '0.95rem', marginBottom: '0.75rem' }}>
                  {s.titre}
                </h3>
                <p style={{ color: '#78716C', fontSize: '0.82rem', lineHeight: 1.7 }}>{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ color: '#78716C', marginTop: '0.5rem', fontSize: '0.95rem' }}>
...
out = Path(r"C:\Users\HP\Desktop\cours\Tecnologie Web et Mobile\tp_twm\app\page.tsx")
